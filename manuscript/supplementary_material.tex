...
\begin{table}[H]
\centering
\caption{Catalog coverage across ranking methods in the final diversity-aware rerun. Catalog coverage is defined as $\left|\bigcup_{q\in Q}S_K(q)\right|/20{,}372$ across the five query scenarios and ten seeds, with top-$K=5$. This metric is distinct from Unique@K, which measures within-list uniqueness.}
\label{tab:s_catalog_coverage}
\scriptsize
\setlength{\tabcolsep}{3pt}
\resizebox{\linewidth}{!}{%
\begin{tabular}{lrrrrrrp{4.3cm}}
\toprule
\textbf{Method} & \textbf{Number of unique recommended QMOF records} & \textbf{Total catalog size} & \textbf{Catalog coverage} & \textbf{Query scenarios} & \textbf{Number of seeds} & \textbf{Top-K} & \textbf{Aggregation protocol}\\
\midrule
WeightedSum & 16 & 20{,}372 & 0.000785 & 5 & 10 & 5 & Union of saved top-$K$ lists divided by 20{,}372\\
LEA baseline & 32 & 20{,}372 & 0.001571 & 5 & 10 & 5 & Union of saved top-$K$ lists divided by 20{,}372\\
MMR & 34 & 20{,}372 & 0.001669 & 5 & 10 & 5 & Union of saved top-$K$ lists divided by 20{,}372\\
ParetoCrowding & 50 & 20{,}372 & 0.002454 & 5 & 10 & 5 & Union of saved top-$K$ lists divided by 20{,}372\\
SemanticOnly & 163 & 20{,}372 & 0.008001 & 5 & 10 & 5 & Union of saved top-$K$ lists divided by 20{,}372\\
Random & 236 & 20{,}372 & 0.011585 & 5 & 10 & 5 & Union of saved top-$K$ lists divided by 20{,}372\\
\bottomrule
\end{tabular}
\unskip}
\end{table}

Aggregation protocol: for each method, unique QMOF identifiers were pooled over all saved top-$K$ recommendation lists from the five query scenarios and ten seeds, then divided by the full local catalog size of 20{,}372 records. Unique@K remains a separate within-list metric and equals 1.000 for every method in the aggregate table.

\begin{table}[H]
\centering
\caption{Query-block LEA--WeightedSum hybrid material diversity differences. Values are query-level means over ten seeds.}
\label{tab:s_query_block_diversity}
\scriptsize
\setlength{\tabcolsep}{2pt}
\resizebox{\linewidth}{!}{%
\begin{tabular}{p{3.1cm}rrrr}
\toprule
\textbf{Query scenario} & \textbf{WeightedSum diversity} & \textbf{LEA diversity} & \textbf{LEA minus WeightedSum} & \textbf{Number of seeds}\\
\midrule
CO$_2$ adsorption & 0.0163 & 0.0288 & 0.0125 & 10\\
Photocatalysis & 0.0150 & 0.0150 & 0.0000 & 10\\
Lightweight storage & 0.0165 & 0.0193 & 0.0028 & 10\\
Balanced discovery & 0.0165 & 0.0194 & 0.0029 & 10\\
Insulating frameworks & 0.0293 & 0.0294 & 0.0001 & 10\\
\midrule
\textbf{Summary} & -- & -- & Mean 0.0037; median 0.0028; SD 0.0051; min 0.0000; max 0.0125 & --\\
\bottomrule
\end{tabular}
}
\end{table}

Because there are only five query blocks, these values are reported as descriptive robustness summaries rather than a statistical-superiority claim.
